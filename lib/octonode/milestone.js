...
(function() {
  ...
  Milestone = (function() {
    ...
    Milestone.prototype.info = function(cb) {
      return this.client.get("/api/v3/repos/" + this.repo + "/milestones/" + this.number, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 200) {
    ...
    Milestone.prototype.update = function(obj, cb) {
      return this.client.post("/api/v3/repos/" + this.repo + "/milestones/" + this.number, obj, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 200) {
    ...
    Milestone.prototype["delete"] = function(cb) {
      return this.client.del("/api/v3/repos/" + this.repo + "/milestones/" + this.number, {}, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 204) {
