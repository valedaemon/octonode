...
(function() {
  ...
  Search = (function() {
    ...
    Search.prototype.issues = function(params, cb) {
      return this.client.get("/api/v3/search/issues", params, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 200) {
    ...
    Search.prototype.repos = function(params, cb) {
      return this.client.get("/api/v3/search/repositories", params, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 200) {
    ...
    Search.prototype.users = function(params, cb) {
      return this.client.get("/api/v3/search/users", params, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 200) {
    ...
    Search.prototype.code = function(params, cb) {
      return this.client.get("/api/v3/search/code", params, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 200) {
