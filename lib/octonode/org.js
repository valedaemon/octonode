...
(function() {
  ...
  Org = (function() {
    ...
    Org.prototype.info = function(cb) {
      return this.client.get("/api/v3/orgs/" + this.name, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 200) {
    ...
    Org.prototype.update = function(info, cb) {
      return this.client.post("/api/v3/orgs/" + this.name, info, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 200) {
    ...
    Org.prototype.repos = function() {
      ...
      return (ref = this.client).get.apply(ref, ["/api/v3/orgs/" + this.name + "/repos"].concat(slice.call(params), [function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 200) {
    ...
    Org.prototype.createRepo = function(repo, cb) {
      return this.client.post("/api/v3/orgs/" + this.name + "/repos", repo, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 201) {
    ...
    Org.prototype.teams = function() {
      var cb, i, params, ref;
      params = 2 <= arguments.length ? slice.call(arguments, 0, i = arguments.length - 1) : (i = 0, []), cb = arguments[i++];
      return (ref = this.client).get.apply(ref, ["/api/v3/orgs/" + this.name + "/teams"].concat(slice.call(params), [function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 200) {
    ...
    Org.prototype.members = function() {
      var cb, i, params, ref;
      params = 2 <= arguments.length ? slice.call(arguments, 0, i = arguments.length - 1) : (i = 0, []), cb = arguments[i++];
      return (ref = this.client).get.apply(ref, ["/api/v3/orgs/" + this.name + "/members"].concat(slice.call(params), [function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 200) {
    ...
    Org.prototype.membership = function(user, cb) {
      return this.client.getOptions("/api/v3/orgs/" + this.name + "/memberships/" + user, {
        headers: {
    ...
    Org.prototype.member = function(user, cb) {
      return this.client.getNoFollow("/api/v3/orgs/" + this.name + "/members/" + user, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
    ...
    Org.prototype.publicMember = function(user, cb) {
      return this.client.getNoFollow("/api/v3/orgs/" + this.name + "/public_members/" + user, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        return cb(null, s === 204, h);
    ...
    Org.prototype.publicizeMembership = function(user, cb) {
      return this.client.put("/api/v3/orgs/" + this.name + "/public_members/" + user, null, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 204) {
    ...
    Org.prototype.concealMembership = function(user, cb) {
      return this.client.del("/api/v3/orgs/" + this.name + "/public_members/" + user, null, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 204) {
    ...
    Org.prototype.addMember = function(user, options, cb) {
      return this.client.put("/api/v3/orgs/" + this.name + "/memberships/" + user, options, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 204) {
    ...
    Org.prototype.removeMember = function(user, cb) {
      return this.client.del("/api/v3/orgs/" + this.name + "/members/" + user, null, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 204) {
    ...
    Org.prototype.createTeam = function(options, cb) {
      return this.client.post("/api/v3/orgs/" + this.name + "/teams", options, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 201) {
