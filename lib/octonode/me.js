...
(function() {
  ...
  Me = (function() {
    ...
    Me.prototype.info = function(cb) {
      return this.client.get('/api/v3/user', function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 200) {
    ...
    Me.prototype.update = function(info, cb) {
      return this.client.post('/api/v3/user', info, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 200) {
    ...
    Me.prototype.emails = function(cbOrEmails, cb) {
      if ((cb != null) && typeof cbOrEmails !== 'function') {
        ...
        cb = cbOrEmails;
        return this.client.get('/api/v3/user/emails', function(err, s, b, h) {
          if (err) {
            return cb(err);
          }
          if (s !== 200) {
    ...
    Me.prototype.emailsDetailed = function(cb) {
      return this.client.getOptions('/api/v3/user/emails', {
        headers: {
    ...
    Me.prototype.setEmails = function(emails, cb) {
      return this.client.post('/api/v3/user/emails', emails, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 201) {
    ...
    Me.prototype.deleteEmails = function(emails, cb) {
      return this.client.del('/api/v3/user/emails', emails, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 204) {
    ...
    Me.prototype.followers = function() {
      ...
      return (ref = this.client).get.apply(ref, ['/api/v3/user/followers'].concat(slice.call(params), [function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 200) {
    ...
    Me.prototype.following = function(cbOrUser, cb) {
      if ((cb != null) && typeof cbOrUser !== 'function') {
        ...
        cb = cbOrUser;
        return this.client.get('/api/v3/user/following', function(err, s, b, h) {
          if (err) {
            return cb(err);
          }
          if (s !== 200) {
    ...
    Me.prototype.checkFollowing = function(user, cb) {
      return this.client.get("/api/v3/user/following/" + user, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
    ...
    Me.prototype.follow = function(user, cb) {
      return this.client.put("/api/v3/user/following/" + user, {}, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 204) {
    ...
    Me.prototype.unfollow = function(user, cb) {
      return this.client.del("/api/v3/user/following/" + user, {}, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 204) {
    ...
    Me.prototype.starred = function() {
      var cb, i, params, ref;
      params = 2 <= arguments.length ? slice.call(arguments, 0, i = arguments.length - 1) : (i = 0, []), cb = arguments[i++];
      return (ref = this.client).get.apply(ref, ['/api/v3/user/starred'].concat(slice.call(params), [function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 200) {
    ...
    Me.prototype.checkStarred = function(repo, cb) {
      return this.client.get("/api/v3/user/starred/" + repo, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        return cb(null, s === 204, h);
    ...
    Me.prototype.star = function(repo, cb) {
      return this.client.put("/api/v3/user/starred/" + repo, {}, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 204) {
    ...
    Me.prototype.unstar = function(repo, cb) {
      return this.client.del("/api/v3/user/starred/" + repo, {}, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 204) {
    ...
    Me.prototype.watched = function() {
      var cb, i, params, ref;
      params = 2 <= arguments.length ? slice.call(arguments, 0, i = arguments.length - 1) : (i = 0, []), cb = arguments[i++];
      return (ref = this.client).get.apply(ref, ['/api/v3/user/subscriptions'].concat(slice.call(params), [function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 200) {
    ...
    Me.prototype.keys = function(cbOrIdOrKey, cbOrKey, cb) {
      if ((cb == null) && typeof cbOrIdOrKey === 'number' && typeof cbOrKey === 'function') {
        ...
        cb = cbOrIdOrKey;
        return this.client.get('/api/v3/user/keys', function(err, s, b, h) {
          if (err) {
            return cb(err);
          }
          if (s !== 200) {
    ...
    Me.prototype.getKey = function(id, cb) {
      return this.client.get("/api/v3/user/keys/" + id, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 200) {
    ...
    Me.prototype.createKey = function(key, cb) {
      return this.client.post('/api/v3/user/keys', key, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 201) {
    ...
    Me.prototype.updateKey = function(id, key, cb) {
      return this.client.post("/api/v3/user/keys/" + id, key, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 200) {
    ...
    Me.prototype.deleteKey = function(id, cb) {
      return this.client.del("/api/v3/user/keys/" + id, {}, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 204) {
    ...
    Me.prototype.orgs = function() {
      var cb, i, params, ref;
      params = 2 <= arguments.length ? slice.call(arguments, 0, i = arguments.length - 1) : (i = 0, []), cb = arguments[i++];
      return (ref = this.client).get.apply(ref, ["/api/v3/user/orgs"].concat(slice.call(params), [function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 200) {
    ...
    Me.prototype.repos = function() {
      var cb, i, params, ref;
      params = 2 <= arguments.length ? slice.call(arguments, 0, i = arguments.length - 1) : (i = 0, []), cb = arguments[i++];
      return (ref = this.client).get.apply(ref, ["/api/v3/user/repos"].concat(slice.call(params), [function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 200) {
    ...
    Me.prototype.createRepo = function(repo, cb) {
      return this.client.post("/api/v3/user/repos", repo, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 201) {
    ...
    Me.prototype.fork = function(repo, cb) {
      return this.client.post("/api/v3/repos/" + repo + "/forks", {}, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 202) {
    ...
    Me.prototype.notifications = function(options, cb) {
      ...
      return this.client.get("/api/v3/notifications", options, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 200) {
    ...
    Me.prototype.checkWatching = function(repo, cb) {
      return this.client.get("/api/v3/repos/" + repo + "/subscription", function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s === 200) {
    ...
    Me.prototype.subscribe = function(repo, cb) {
      ...
      return this.client.put("/api/v3/repos/" + repo + "/subscription", options, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 200) {
    ...
    Me.prototype.unsubscribe = function(repo, cb) {
      return this.client.del("/api/v3/repos/" + repo + "/subscription", function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 204) {
    ...
    Me.prototype.issues = function() {
      var cb, i, params, ref;
      params = 2 <= arguments.length ? slice.call(arguments, 0, i = arguments.length - 1) : (i = 0, []), cb = arguments[i++];
      return (ref = this.client).get.apply(ref, ["/api/v3/user/issues"].concat(slice.call(params), [function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 200) {
    ...
    Me.prototype.teams = function() {
      var cb, i, params, ref;
      params = 2 <= arguments.length ? slice.call(arguments, 0, i = arguments.length - 1) : (i = 0, []), cb = arguments[i++];
      return (ref = this.client).get.apply(ref, ["/api/v3/user/teams"].concat(slice.call(params), [function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 200) {
