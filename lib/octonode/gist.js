...
(function() {
  ...
  Gist = (function() {
    ...
    Gist.prototype.list = function() {
      ...
      return (ref = this.client).get.apply(ref, ["/api/v3/gists"].concat(slice.call(params), [function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 200) {
    ...
    Gist.prototype["public"] = function() {
      var cb, i, params, ref;
      params = 2 <= arguments.length ? slice.call(arguments, 0, i = arguments.length - 1) : (i = 0, []), cb = arguments[i++];
      return (ref = this.client).get.apply(ref, ["/api/v3/gists/public"].concat(slice.call(params), [function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 200) {
    ...
    Gist.prototype.starred = function() {
      var cb, i, params, ref;
      params = 2 <= arguments.length ? slice.call(arguments, 0, i = arguments.length - 1) : (i = 0, []), cb = arguments[i++];
      return (ref = this.client).get.apply(ref, ["/api/v3/gists/starred"].concat(slice.call(params), [function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 200) {
    ...
    Gist.prototype.user = function() {
      ...
      return (ref = this.client).get.apply(ref, ["/api/v3/users/" + user + "/gists"].concat(slice.call(params), [function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 200) {
    ...
    Gist.prototype.get = function(id, cb) {
      return this.client.get("/api/v3/gists/" + id, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 200) {
    ...
    Gist.prototype.create = function(gist, cb) {
      return this.client.post("/api/v3/gists", gist, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 201) {
    ...
    Gist.prototype.edit = function(id, gist, cb) {
      return this.client.post("/api/v3/gists/" + id, gist, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 200) {
    ...
    Gist.prototype["delete"] = function(id, cb) {
      return this.client.del("/api/v3/gists/" + id, {}, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 204) {
    ...
    Gist.prototype.fork = function(id) {
      return this.client.post("/api/v3/gists/" + id + "/forks", {}, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 201) {
    ...
    Gist.prototype.star = function(id, cb) {
      return this.client.put("/api/v3/gists/" + id + "/star", {}, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 204) {
    ...
    Gist.prototype.unstar = function(id, cb) {
      return this.client.del("/api/v3/gists/" + id + "/unstar", {}, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 204) {
    ...
    Gist.prototype.check = function(id, cb) {
      return this.client.get("/api/v3/gists/" + id + "/star", function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
    ...
    Gist.prototype.listComments = function(id, cb) {
      return this.client.get("/api/v3/gists/" + id + "/comments", function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 200) {
    ...
    Gist.prototype.getComment = function(id, cb) {
      return this.client.get("/api/v3/gists/comments/" + id, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 200) {
    ...
    Gist.prototype.createComment = function(id, comment, cb) {
      return this.client.post("/api/v3/gists/" + id + "/comments", comment, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 201) {
    ...
    Gist.prototype.updateComment = function(id, comment, cb) {
      return this.client.post("/api/v3/gists/comments/" + id, comment, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 200) {
    ...
    Gist.prototype.deleteComment = function(id, cb) {
      return this.client.del("/api/v3/gists/comments/" + id, {}, function(err, s, b, h) {
        if (err) {
          return cb(err);
        }
        if (s !== 204) {
